# AI Agent 项目开发提示词 (AI Agent Development Prompt)

> 本文件记录了本项目中工程开发 AI Agent 必须严格遵守的系统提示词与执行规范。
> 任何后续会话或 AI 代理接入本项目时，均以此处定义的工作流与准则为准。
...
3. 读取项目规则（`AGENTS.md`）。
4. 读取 `docs/AI/GOAL.md`、`docs/AI/TASK_INDEX.md` 和 `docs/AI/SESSION_STATE.md`。
...
### Task 模板 (`docs/AI/tasks/TASK-xxx.md`)
